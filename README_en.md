...
Supports classic 2D B/S automata, six special engines, full grid editing, and ES/EN internationalization.
...
├── canvas-controller.js          # Canvas interaction (drawing, selection, pan)
├── display-controller.js         # Header: active rule, neighborhood, mode indicator
├── special-mode-controller.js    # Toggles and controls for each special engine
