    ...
    _loadTranslations() {
        this.translations = {
            es: {
                ...
                'config.zoom': 'Zoom:',
                'config.wrap': 'Bordes',
                'config.wrap.both': 'Toroidal ∞',
                'config.wrap.horizontal': 'Cilíndrico ↔',
                'config.wrap.vertical': 'Cilíndrico ↕',
                'config.wrap.none': 'Plano □',
                ...
                'hex.title': 'Hexagonal',
                'hex.enable': 'Autómata Hexagonal',
                'hex.birth': 'Nacimiento',
                'hex.survival': 'Supervivencia',
                'hex.hint': '6 vecinos. Dibuja 2+ células adyacentes.',
                'notif.hex.enabled': 'Modo Hexagonal: {rule}',
                'notif.hex.error': 'Error al cargar el motor hexagonal',
                'app.title.hex': 'Autómata Celular — Hex {rule}',
                'hex.neighborhood': '6 vecinos hexagonales · {wrap}',
                ...
                'instructions.shortcut.plus': 'Aumentar velocidad',
                'instructions.shortcut.minus': 'Reducir velocidad',
                ...
                'welcome.section.header.text': 'Muestra la regla activa, información de vecindad, y opciones de visibilidad de la cuadrícula.',
                ...
                'welcome.section.patterns.text': 'Biblioteca de patrones predefinidos, controles de ejecución (play / pausa / paso), velocidad, y accesos directos a importar y exportar patrones.',
            ...
            en: {
                ...
                'config.wrap': 'Edges',
                'config.wrap.both': 'Toroidal ∞',
                'config.wrap.horizontal': 'Cylindrical ↔',
                'config.wrap.vertical': 'Cylindrical ↕',
                'config.wrap.none': 'Flat □',
                ...
                'hex.title': 'Hexagonal',
                'hex.enable': 'Hexagonal Automaton',
                'hex.birth': 'Birth',
                'hex.survival': 'Survival',
                'hex.hint': '6 neighbors. Draw 2+ adjacent cells.',
                'notif.hex.enabled': 'Hexagonal Mode: {rule}',
                'notif.hex.error': 'Error loading Hexagonal engine',
                'app.title.hex': 'Cellular Automaton — Hex {rule}',
                'hex.neighborhood': '6 hexagonal neighbors · {wrap}',
                ...
                'instructions.shortcut.plus': 'Increase speed',
                'instructions.shortcut.minus': 'Decrease speed',
                ...
                'welcome.section.header.text': 'Shows the active rule, neighborhood info, and grid visibility options.',
                ...
                'welcome.section.patterns.text': 'A library of predefined patterns, play/pause/step controls, speed buttons, and quick buttons to import/export patterns.',
